# for some reason does not work, but is not needed right now
# ####################################################
...
target, perfect_solution= utils.generate_target(100, 100, 0.8, the_forbidden_pieces)
...
if not valid or len(error_pieces)!=0:
    if len(error_pieces) != 0:
        print('WARNING: {} pieces ha0ve a wrong shapeID. They are labelled in image of the solution, and their PieceID are: {}.'
    ...
    if time_set > 600:
        ...
        print("Overall accuracy is: {:.2f}%".format(100 - ((100 * missing / total_blocks) + (100 * excess / total_blocks))))
